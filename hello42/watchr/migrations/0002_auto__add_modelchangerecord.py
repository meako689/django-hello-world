...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ModelChangeRecord'
        db.create_table(u'watchr_modelchangerecord', (
            ...
            ('shelfed_object', self.gf('json_field.fields.JSONField')(default=u'null')),
        ))
        db.send_create_signal(u'watchr', ['ModelChangeRecord'])


    def backwards(self, orm):
        # Deleting model 'ModelChangeRecord'
        db.delete_table(u'watchr_modelchangerecord')
