...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecordedRequest.priority'
        db.add_column(u'watchr_recordedrequest', 'priority',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecordedRequest.priority'
        db.delete_column(u'watchr_recordedrequest', 'priority')
